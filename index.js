...
VideoPlayer.propTypes = {
  ...
  customStyles: PropTypes.shape({
    wrapper: PropTypes.any.style,
    video: Video.propTypes.style,
    videoWrapper: PropTypes.any.style,
    controls: PropTypes.any.style,
    ...
    seekBar: PropTypes.any.style,
    seekBarFullWidth: PropTypes.any.style,
    seekBarProgress: PropTypes.any.style,
    seekBarKnob: PropTypes.any.style,
    seekBarKnobSeeking: PropTypes.any.style,
    seekBarBackground: PropTypes.any.style,
